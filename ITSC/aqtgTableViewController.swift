...
class aqtgTableViewController: UITableViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "aqtgCell", for: indexPath) as! MyTableViewCell
    ...
    func readNewsList() -> BlockOperation{
        ...
        for idx in 0..<NumListToFetch{
            operation.addExecutionBlock{
                ...
                let url = URL(string: String(format: aqtgUrl, idx + 1))
